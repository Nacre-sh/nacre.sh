...
Navigate smoothly with preview, completion and your favorite builtins: `ls`, `cd`, `chmod`, `chown`, `stat`, `grep`, and [more](docs#builtins).

![builtins_black](https://user-images.githubusercontent.com/11426226/160006956-f44a6bf0-96f6-475c-93db-b42f1be230ba.gif)

## Automatic module loading

The [auto-require](getting-started#auto-require) mechanism imports your modules when you need it. Explicit import can also be done with `require()`.
