...
**Feedback matters a lot to us**. We believe this is the only way to shape the most relevant roadmap for the next phase (beta). Tell us what you like, hate, expect, unexpect, wish to have, etc. on [Discord](https://discord.gg/AdVQfgqGBn) or by creating [issues on GitHub](https://github.com/Nacre-sh/nacre/issues).
